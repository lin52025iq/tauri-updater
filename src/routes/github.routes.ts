...
import { getLatestRelease, downloadGitHubAsset, checkUpdate } from '../services'
...
// 获取最新发布版本
githubRoutes.all('/github/:username/:reponame/latest', async (c) => {
...
// 检查更新
githubRoutes.get('/check/:username/:reponame/:platform/:arch/:version', async (c) => {
...
// 下载资产
githubRoutes.get('/github/download-asset', async (c) => {
